...
class AICourseGenerator {
    ...
    public function __construct() {
        ...
        $this->model = defined('OPENROUTER_MODEL') ? OPENROUTER_MODEL : 'google/gemini-2.5-flash';
...
- "chapters": Array of chapters, each with:
  ...
  - "lessons": Array of lessons, each with:
    - "title": Lesson title
    - "content": Brief lesson summary or introduction (30-50 words). Do NOT write full 500-word lessons here.

Generate 3-4 chapters with 2-4 lessons each. Focus on a well-structured curriculum.
