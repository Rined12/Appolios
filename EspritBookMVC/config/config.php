...
define('CHAT_UPLOAD_DIR', PROJECT_ROOT . DIRECTORY_SEPARATOR . 'uploads' . DIRECTORY_SEPARATOR . 'chat');
define('CHAT_UPLOAD_URL', $scheme . '://' . $host . dirname($appBaseDir) . '/uploads/chat');
define('CHAT_UPLOAD_MAX_BYTES', 10 * 1024 * 1024);
define('SOCKET_IO_URL', 'http://localhost:3001');
