            ...
            <div class="admin-main">
                ...
                <div class="header collab-hero">
                    <div class="collab-hero__inner">
                        <div>
                            <div class="collab-eyebrow"><i class="bi bi-sliders" aria-hidden="true"></i> Admin</div>
                            <h1>Edit discussion</h1>
                            <p>Update the thread, group assignment, or approval status.</p>
                        </div>
                ...
                <div class="collab-form-shell">
                    <form method="POST" action="<?= APP_ENTRY ?>?url=admin/sl-discussions/<?= (int) ($d['id_discussion'] ?? $d['id'] ?? 0) ?>/update" novalidate>
                        ...
                        <div class="form-group">
                            <label>Title</label>
                            <input type="text" name="titre" value="<?= htmlspecialchars((string) ($old['titre'] ?? ($d['titre'] ?? $d['title'] ?? ''))) ?>" data-js-required="1">
                        ...
                        <div class="form-group">
                            <label>Content</label>
                            <textarea name="contenu" rows="6" data-js-required="1"><?= htmlspecialchars((string) ($old['contenu'] ?? ($d['contenu'] ?? $d['content'] ?? ''))) ?></textarea>
                        ...
                        <div style="display:flex;flex-wrap:wrap;gap:0.65rem;align-items:center;margin-top:0.5rem;">
                            <button class="collab-btn-primary" type="submit">
                                <i class="bi bi-check-lg" aria-hidden="true"></i> Update discussion
                            </button>
