                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($user['id'] != $_SESSION['user_id']): ?>
                                            <a href="<?= APP_ENTRY ?>?url=admin/delete-user/<?= $user['id'] ?>" class="btn action-btn danger" style="padding: 5px 10px; font-size: 0.8rem;" onclick="return confirm('Are you sure you want to delete this user?')">Delete</a>
                                        <?php else: ?>
