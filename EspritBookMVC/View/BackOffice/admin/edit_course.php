        ...
        <div class="admin-layout">
            ...
            <div class="admin-main">
                ...
                <div class="form-container" style="max-width: 700px;">
                    <form action="<?= APP_ENTRY ?>?url=admin/update-course/<?= $course['id'] ?>" method="POST" novalidate id="admin-course-edit-form">
...
document.addEventListener('DOMContentLoaded', function () {
    const form = document.getElementById('admin-course-edit-form');
    if (!form) {
        return;
    }
