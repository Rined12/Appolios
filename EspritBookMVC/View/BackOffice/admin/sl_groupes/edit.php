        ...
        <div class="admin-layout">
            ...
            <div class="admin-main">
                ...
                <div class="table-container" style="max-width:780px;">
                    <form method="POST" action="<?= APP_ENTRY ?>?url=admin/sl-groupes/<?= (int) ($g['id_groupe'] ?? 0) ?>/update" novalidate style="padding:18px;">
                        <div style="margin-bottom:12px;">
                            <label>Group Name</label>
                            <input type="text" name="nom_groupe" value="<?= htmlspecialchars((string) ($old['nom_groupe'] ?? ($g['nom_groupe'] ?? ''))) ?>" data-js-required="1" style="width:100%;">
                            <?php if (!empty($errors['nom_groupe'])): ?><small style="color:#b91c1c;"><?= htmlspecialchars((string) $errors['nom_groupe']) ?></small><?php endif; ?>
                        </div>
                        <div style="margin-bottom:12px;">
                            <label>Description</label>
                            <textarea name="description" rows="5" data-js-required="1" style="width:100%;"><?= htmlspecialchars((string) ($old['description'] ?? ($g['description'] ?? ''))) ?></textarea>
                        ...
                        <div style="margin-bottom:16px;">
                            ...
                            <?php $s = (string) ($old['approval_statut'] ?? ($g['approval_statut'] ?? 'en_cours')); ?>
