                ...
                <section class="neo-auth-wrap" style="background: transparent; font-family: 'Inter', sans-serif;">
                    ...
                    <div class="neo-glass-card" style="width: 100%; background: #ffffff; border-radius: 20px; box-shadow: 0 15px 40px rgba(43, 72, 101, 0.08); border: 1px solid rgba(233, 241, 250, 0.8); overflow: hidden; display: flex; flex-direction: column;">
                        ...
                        <div style="padding: 3.5rem; background: #fcfcfc; position: relative; overflow: hidden; border-bottom: 1px solid #eef2f6;">
                            ...
                            <div style="position: relative; z-index: 2;">
                                ...
                                <h2 style="font-size: 2.8rem; font-weight: 800; color: #2B4865; line-height: 1.15; margin: 0 0 0.5rem 0; letter-spacing: -0.02em;">
                                    Edit <span style="color: #E19864;">Evenement</span>
                                </h2>
                                <p style="color: #64748b; font-size: 1.1rem; line-height: 1.6; margin: 0 0 1rem 0; max-width: 90%;">
                                    Update your event proposal. Any changes on an approved evenement will send it back to pending status for admin review.
                                </p>
                        ...
                        <div style="padding: 3rem; background: #ffffff;">
                            <form action="<?= APP_ENTRY ?>?url=teacher/update-evenement/<?= (int) ($evenement['id'] ?? 0) ?>" method="POST" class="neo-form-grid" novalidate>
                                ...
                                <div class="neo-form-group">
                                    ...
                                    <input type="number" id="capacite_max" name="capacite_max" data-js-min="0" placeholder="Ex: 200" value="<?= htmlspecialchars((string) $form['capacite_max']) ?>" class="neo-input <?= isset($errors['capacite_max']) ? 'neo-error-input' : '' ?>">
                                ...
                                <div class="col-span-2" style="margin-top: 1.5rem;">
                                    <button type="submit" class="neo-submit-btn">Save Changes</button>
                                </div>
                            </form>
                        </div>
