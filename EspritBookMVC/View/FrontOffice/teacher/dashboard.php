                    ...
                    <div class="pro-main-col" style="display: flex; flex-direction: column; gap: 2rem;">
                        ...
                        <div style="background: white; border-radius: 20px; padding: 2rem; box-shadow: 0 5px 20px rgba(0,0,0,0.03); border: 1px solid #eef2f6;">
                            ...
                            <div style="display: flex; flex-wrap: wrap; gap: 1rem;">
                                <a href="<?= APP_ENTRY ?>?url=teacher/add-course" class="pro-action-btn primary">Add New Course</a>
                                <a href="<?= APP_ENTRY ?>?url=teacher/add-evenement" class="pro-action-btn primary" style="background: #E19864; color: white;">Propose Event</a>
                                <a href="<?= APP_ENTRY ?>?url=teacher/courses" class="pro-action-btn outline">My Courses</a>
                                <a href="<?= APP_ENTRY ?>?url=teacher/evenements" class="pro-action-btn outline">Manage Events</a>
                                <a href="<?= APP_ENTRY ?>?url=teacher/groupes" class="pro-action-btn outline">Groups</a>
                                <a href="<?= APP_ENTRY ?>?url=teacher/discussions" class="pro-action-btn outline">Discussions</a>
                            </div>
                        </div>
