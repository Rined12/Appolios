...
$formData = [
    ...
    'video_url' => $old['video_url'] ?? ($course['video_url'] ?? '')
];
?>
...
<div class="dashboard">
    <div class="container admin-dashboard-container">
        ...
        <div class="form-container" style="max-width: 700px;">
            <form action="<?= APP_ENTRY ?>?url=teacher/update-course/<?= $course['id'] ?>" method="POST" novalidate id="teacher-course-edit-form">
                <div class="form-group">
                    <label for="title">Course Title *</label>
                    <input type="text" id="title" name="title" placeholder="Enter course title" value="<?= htmlspecialchars($formData['title']) ?>" style="<?= isset($errors['title']) ? 'border-color: #ef4444; background: #fef2f2;' : '' ?>">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" placeholder="Describe what students will learn in this course" style="<?= isset($errors['description']) ? 'border-color: #ef4444; background: #fef2f2;' : '' ?>"><?= htmlspecialchars($formData['description']) ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="video_url" name="video_url" placeholder="https://youtube.com/watch?v=..." value="<?= htmlspecialchars($formData['video_url']) ?>" style="<?= isset($errors['video_url']) ? 'border-color: #ef4444; background: #fef2f2;' : '' ?>">
...
document.addEventListener('DOMContentLoaded', function () {
    const form = document.getElementById('teacher-course-edit-form');
    if (!form) {
        return;
    }
