...
<div class="dashboard">
    <div class="container admin-dashboard-container">
        ...
        <div class="form-container" style="max-width: 700px;">
            <form action="<?= APP_ENTRY ?>?url=teacher/update-course/<?= $course['id'] ?>" method="POST" novalidate>
                <div class="form-group">
                    <label for="title">Course Title *</label>
                    <input type="text" id="title" name="title" placeholder="Enter course title" value="<?= htmlspecialchars($course['title']) ?>" style="<?= isset($errors['title']) ? 'border-color: #ef4444; background: #fef2f2;' : '' ?>">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" placeholder="Describe what students will learn in this course" style="<?= isset($errors['description']) ? 'border-color: #ef4444; background: #fef2f2;' : '' ?>"><?= htmlspecialchars($course['description']) ?></textarea>
