    ...
    <div class="container admin-dashboard-container">
        <div class="admin-layout">
            ...
            <div class="admin-main">
                ...
                <header class="collab-hero" style="margin-bottom:1.2rem;">
                ...
                <div style="display:grid;grid-template-columns:1.1fr 0.9fr;gap:1.1rem;align-items:start;" class="group-edit-grid">
                    <section class="collab-form-shell" style="max-width:none;">
                    ...
                    <aside style="display:flex;flex-direction:column;gap:1rem;">
                        <section class="collab-detail-sidecard" style="padding:1.1rem 1.1rem 1.25rem;">
                        ...
                        <section class="collab-detail-sidecard" style="padding:1rem 1.1rem;">
