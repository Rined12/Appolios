        ...
        <div class="admin-layout">
            ...
            <div class="admin-main">
                ...
                <div style="display:flex; gap:12px; flex-wrap:wrap; margin-bottom:2rem;">
                    <a href="<?= APP_ENTRY ?>?url=student/groupes" class="student-courses-hero-btn student-courses-hero-btn-primary" style="text-decoration:none; display:inline-flex; align-items:center; gap:8px; padding:10px 16px; border-radius:10px;">
                        <span>Groups</span>
                    </a>
                    <a href="<?= APP_ENTRY ?>?url=student/discussions" class="student-courses-hero-btn" style="text-decoration:none; display:inline-flex; align-items:center; gap:8px; padding:10px 16px; border-radius:10px; border:1px solid #cbd5e1; color:#1e293b; background:#fff;">
