...
(function() {
    ...
    // Use absolute path via global variable defined in footer
    var APP_API = (window.APP_URL || '') + '/Controller/ChatbotController.php';
    ...
    function loadHistory() {
        fetch(APP_API + '?action=history&session_id=' + encodeURIComponent(sessionId))
        .then(res => res.json())
        .then(data => {
