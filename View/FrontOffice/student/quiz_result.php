        ...
        <div class="admin-layout">
            ...
            <div class="admin-main pro-table-page">
                <div class="pro-table-head">
                    <div>
                        <h1 style="color: #f8fafc; font-weight: 800; font-size: 1.8rem; margin-bottom: 5px;">Résultat du quiz</h1>
                        <p style="color: #94a3b8; font-size: 0.95rem;"><?= htmlspecialchars($quiz['title'] ?? '') ?></p>
                    </div>
                    <div class="pro-table-actions">
                        <?php if ($good && !empty($cert['verify_url'])): ?>
                            <a class="btn btn-stats-pro" href="<?= APP_ENTRY ?>?url=student-quiz/cert-qr/<?= (int) ($cert['attempt_id'] ?? 0) ?>" style="background: linear-gradient(135deg, #6366f1, #a855f7) !important; color: white !important; border: none !important;">
                                <i class="bi bi-award" aria-hidden="true" style="animation: pulse 2s infinite;"></i>
                                Certificat QR
                                <span class="btn-stats-pro-badge" style="background: rgba(255,255,255,0.2); border: none; color: white;">PRO</span>
                            </a>
                        <?php endif; ?>
                        <?php if ($pct < 60): ?>
                            <a href="<?= APP_ENTRY ?>?url=student-quiz/remedial/<?= (int) ($quiz['id'] ?? 0) ?>" class="btn btn-training-pro" style="background: linear-gradient(135deg, #E19864, #d9804b) !important; color: white !important; border: none !important;">
                                <i class="bi bi-lightning-charge" aria-hidden="true"></i>
                                Rattrapage
                                <span class="btn-training-pro-badge" style="background: rgba(255,255,255,0.2); border: none; color: white;">GO</span>
                            </a>
                        <?php endif; ?>
                        <a href="<?= APP_ENTRY ?>?url=student-quiz/quiz" class="btn btn-outline" style="border: 1px solid rgba(255,255,255,0.15) !important; background: rgba(255,255,255,0.03) !important; color: #f8fafc !important;">Liste des quiz</a>
                    </div>
                </div>
