                            ...
                            <div class="certificate-card">
                                ...
                                <div style="display: flex; gap: 10px; margin-top: 1.5rem;">
                                    <button class="view-cert-btn"
                                        ...
                                        style="flex:1; background: linear-gradient(135deg, #eab308, #ca8a04); border: none; color: #1a1a2e; padding: 10px 20px; border-radius: 8px; cursor: pointer; font-weight: 700; font-size: 0.9rem;">View Certificate</button>
                                    <a href="<?= APP_ENTRY ?>?url=student/downloadCertificate/<?= htmlspecialchars($cert['certificate_code']) ?>" class="download-cert-btn" style="flex:1; background: linear-gradient(135deg, #8b5cf6, #7c3aed); border: none; color: white; padding: 10px 20px; border-radius: 8px; cursor: pointer; font-weight: 700; font-size: 0.9rem; text-align: center; text-decoration: none;">Download PDF</a>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
