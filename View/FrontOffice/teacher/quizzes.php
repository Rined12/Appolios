...
<div class="dashboard">
    <div class="container admin-dashboard-container">
        <div class="admin-layout">
            ...
            <div class="admin-main pro-table-page teacher-quiz-surface">
                <div class="pro-table-head">
                    <div>
                        <h1>Quiz</h1>
                        <p class="pro-table-head-lead">Créez des quiz par chapitre, suivez les tentatives et exportez la liste pour analyse.</p>
                    </div>
                    ...
                    <div class="pro-table-wrap">
                        <table class="pro-table" id="teacherQuizTable">
                            ...
                            <tbody>
                                ...
                                <?php endforeach; else: ?>
                                    <tr class="teacher-quiz-empty-row"><td colspan="6" class="teacher-quiz-empty">Aucun quiz pour l’instant. Créez des chapitres dans vos cours, puis ajoutez un quiz.</td></tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    </div>
...
(function () {
  ...
  function visibleRows() {
    return Array.from(table.querySelectorAll('tbody tr')).filter(function (tr) {
      return tr.style.display !== 'none' && !tr.classList.contains('teacher-quiz-empty-row');
    });
  }
  ...
  function sortRows() {
    ...
    if (!tbody) return;
    var emptyRow = tbody.querySelector('tr.teacher-quiz-empty-row');
    var rows = Array.from(tbody.querySelectorAll('tr')).filter(function (tr) {
      return !tr.classList.contains('teacher-quiz-empty-row');
    });
