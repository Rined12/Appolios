        ...
        <div class="admin-layout">
            ...
            <div class="admin-main">
                <div class="dashboard-header" style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:12px;">
                    <h1>Quiz</h1>
                    <a href="<?= APP_ENTRY ?>?url=teacher/add-quiz" class="btn btn-yellow">Nouveau quiz</a>
                </div>
                <?php if (!empty($flash)): ?>
                        ...
                        <table class="data-table" style="width:100%;">
                            ...
                            <?php if (!empty($quizzes)): foreach ($quizzes as $q): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= APP_ENTRY ?>?url=teacher/edit-quiz/<?= (int) $q['id'] ?>" class="btn btn-secondary" style="padding:6px 12px;">Modifier</a>
                                        <a href="<?= APP_ENTRY ?>?url=teacher/delete-quiz/<?= (int) $q['id'] ?>" class="btn action-btn danger" style="padding:6px 12px;" onclick="return confirm('Supprimer ?');">Supprimer</a>
                                    </td>
                                </tr>
                            <?php endforeach; else: ?>
