...
<div class="dashboard teacher-stat-events-page">
...
document.addEventListener("DOMContentLoaded", function() {
    const chartDark = document.body.classList.contains('dark-mode');
    const chartTick = chartDark ? '#94a3b8' : '#64748b';
    const chartGrid = chartDark ? 'rgba(148, 163, 184, 0.22)' : 'rgba(233, 241, 250, 0.8)';
    const chartGridSoft = chartDark ? 'rgba(148, 163, 184, 0.18)' : 'rgba(233, 241, 250, 0.6)';

    // Global Chart Defaults
    Chart.defaults.font.family = "'Inter', sans-serif";
    Chart.defaults.color = chartTick;
    Chart.defaults.scale.grid.color = chartGridSoft;
    ...
    new Chart(ctxMixed, {
        ...
        options: {
            ...
            plugins: {
                legend: { 
                    position: 'top',
                    labels: { font: { weight: '600' }, usePointStyle: true, pointStyle: 'circle', color: chartTick }
                },
                tooltip: {
    ...
    new Chart(ctxEventPart, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderWidth: 1,
                borderColor: chartDark ? 'rgba(30, 41, 59, 0.95)' : '#ffffff',
                hoverOffset: 5
            }]
        },
        options: {
            ...
            plugins: {
                legend: { 
                    position: 'bottom',
                    labels: { padding: 20, font: { weight: '500' }, usePointStyle: true, pointStyle: 'circle', color: chartTick }
                },
                tooltip: {
                    backgroundColor: 'rgba(43, 72, 101, 0.9)',
                    padding: 12,
