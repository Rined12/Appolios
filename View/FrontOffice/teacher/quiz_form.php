            ...
            <div class="admin-main pro-table-page pro-form-page">
                ...
                <form method="post" action="<?= $action ?>" id="quiz-form" onsubmit="return appValidateQuizForm(this);">
                    ...
                    <div class="pro-table-card" style="padding: 12px; margin: 10px 0; background: rgba(255,255,255,.03);">
                        ...
                        <div style="display:flex; gap: 10px; flex-wrap:wrap; align-items:flex-end; margin-bottom: 10px;">
                            ...
                            <div style="flex: 0 0 auto;">
                                <button type="button" class="btn btn-outline" id="ai-blueprint-btn">Blueprint IA</button>
                            </div>
                        </div>
                    ...
                    <div class="pro-form-actions">
                        <button type="button" class="btn btn-outline" id="ai-generate">Générer par IA</button>
...
(function(){
  ...
  btn.addEventListener('click', function(){
    ...
    fetch('<?= APP_ENTRY ?>?url=teacher-quiz/generate-quiz-ai', {
      method: 'POST',
      body: fd,
...
(function(){
  ...
  btn.addEventListener('click', function(){
    ...
    fetch('<?= APP_ENTRY ?>?url=teacher-quiz/generate-blueprint-ai', {
      method: 'POST',
      body: fd,
      credentials: 'same-origin'
    }).then(function(r){ return r.json(); })
