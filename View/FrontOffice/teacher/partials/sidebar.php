...
<aside class="admin-sidebar dark-theme teacher-sidebar-admin">
    <nav class="admin-sidebar-nav" aria-label="Teacher Navigation">
        ...
        <a href="<?= APP_ENTRY ?>?url=teacher/stat-evenements" class="admin-side-link <?= strpos((string)$teacherSidebarActive, 'stat') !== false ? 'active' : '' ?>">
            <span class="admin-side-icon" aria-hidden="true">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <span>Stats Evenements</span>
        </a>

        <a href="<?= APP_ENTRY ?>?url=teacher/groupes" class="admin-side-link <?= ($teacherSidebarActive === 'groupes' || $teacherSidebarActive === 'sl-groupes') ? 'active' : '' ?>">
            <span class="admin-side-icon" aria-hidden="true">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <a href="<?= APP_ENTRY ?>?url=teacher/discussions" class="admin-side-link <?= ($teacherSidebarActive === 'discussions' || $teacherSidebarActive === 'sl-discussions') ? 'active' : '' ?>">
            <span class="admin-side-icon" aria-hidden="true">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <a href="<?= APP_ENTRY ?>?url=teacher-quiz/exam-builder" class="admin-side-link <?= $teacherSidebarActive === 'exam-builder' ? 'active' : '' ?>">
            <span class="admin-side-icon" aria-hidden="true">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <span>Exam Builder (IA)</span>
        </a>

        <a href="<?= APP_ENTRY ?>?url=teacher-quiz/remediation-plan" class="admin-side-link <?= $teacherSidebarActive === 'remediation-plan' ? 'active' : '' ?>">
            <span class="admin-side-icon" aria-hidden="true">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
