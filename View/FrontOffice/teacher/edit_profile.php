        ...
        <div class="admin-layout">
            ...
            <div class="admin-main">
                ...
                <div style="margin-top: 40px; padding-top: 30px; border-top: 1px solid #e2e8f0;">
                    ...
                    <p style="color: #64748b; font-size: 0.9rem; margin-bottom: 20px;">Deleting your account cannot be undone. All your resources and courses will be lost permanently.</p>
                    <form action="<?= APP_ENTRY ?>?url=teacher/delete-account" method="POST" onsubmit="return confirm('Are you absolutely sure you want to permanently delete your account? This action cannot be reversed.');">
