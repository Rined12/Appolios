                ...
                <section class="neo-auth-wrap" style="background: transparent; font-family: 'Inter', sans-serif;">
                    ...
                    <div class="neo-glass-card" style="width: 100%; background: #0f172a; border-radius: 20px; box-shadow: 0 15px 40px rgba(0, 0, 0, 0.2); border: 1px solid rgba(255, 255, 255, 0.1); overflow: hidden; display: flex; flex-direction: column; color: #ffffff;">
                        ...
                        <div class="neo-auth-grid" style="display: grid; grid-template-columns: 1.2fr 1fr; border-bottom: 1px solid rgba(255, 255, 255, 0.05);">
                            ...
                            <div style="padding: 3.5rem; background: rgba(30, 41, 59, 0.3); position: relative; overflow: hidden; display: flex; flex-direction: column; justify-content: center;">
                                ...
                                <div style="position: relative; z-index: 2;">
                                    <h2 style="font-size: 2.8rem; font-weight: 800; color: #ffffff; line-height: 1.15; margin: 0 0 1rem 0; letter-spacing: -0.02em;">
                                        Module<br><span style="color: #E19864;">Evenements</span>
                                    </h2>
                                    ...
                                    <div style="display: flex; gap: 1rem; flex-wrap: wrap;">
                                        <a href="<?= APP_ENTRY ?>?url=admin/dashboard" style="background: rgba(255, 255, 255, 0.05); border: 1.5px solid rgba(255, 255, 255, 0.1); color: #cbd5e1; padding: 12px 24px; border-radius: 10px; font-weight: 600; text-decoration: none; transition: all 0.2s;" onmouseover="this.style.borderColor='#E19864'; this.style.color='#E19864'" onmouseout="this.style.borderColor='rgba(255, 255, 255, 0.1)'; this.style.color='#cbd5e1'">Back to Dashboard</a>
                                        <a href="<?= APP_ENTRY ?>?url=event/evenement-requests" style="background: rgba(225, 152, 100, 0.15); color: #E19864; padding: 12px 24px; border-radius: 10px; font-weight: 600; text-decoration: none; transition: all 0.2s;" onmouseover="this.style.background='rgba(225, 152, 100, 0.25)'" onmouseout="this.style.background='rgba(225, 152, 100, 0.15)'">Teacher Requests</a>
                            ...
                            <!-- Right: The Images -->
                            <div style="padding: 2rem; display: flex; align-items: center; justify-content: center; position: relative; background: #0f172a; overflow: hidden;">
                        ...
                        <div style="padding: 2.5rem 3.5rem; background: transparent;">
                            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem; flex-wrap: wrap; gap: 1rem;">
                                <div>
                                    <h3 style="margin: 0 0 0.5rem 0; color: #ffffff; font-size: 1.6rem; font-weight: 700;">Upcoming Events</h3>
                                    <p style="margin: 0; color: #94a3b8; font-size: 0.95rem;">Manage all scheduled events and their resources.</p>
                                </div>
                                <div style="display: flex; gap: 1rem; align-items: center;">
                                    <div class="custom-select-wrapper" style="position: relative; user-select: none; width: 170px; z-index: 50;">
                                        <div class="custom-select-trigger" style="padding: 10px 15px; border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.1); background: rgba(30, 41, 59, 0.5); color: #cbd5e1; font-family: inherit; font-weight: 500; font-size: 0.95rem; display: flex; justify-content: space-between; align-items: center; cursor: pointer; transition: all 0.2s;">
                                        ...
                                        <div class="custom-select-options" style="position: absolute; top: calc(100% + 8px); left: 0; width: 100%; background: #1e293b; border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 12px; box-shadow: 0 10px 30px rgba(0,0,0,0.3); opacity: 0; visibility: hidden; transform: translateY(-10px); transition: all 0.2s; overflow: hidden; padding: 6px;">
                                            <div class="custom-option" data-value="default" style="padding: 10px 15px; cursor: pointer; border-radius: 8px; font-size: 0.9rem; color: #94a3b8; transition: all 0.2s; margin-bottom: 2px;" onmouseover="this.style.background='rgba(255, 255, 255, 0.05)'; this.style.color='#ffffff'" onmouseout="this.style.background='transparent'; this.style.color='#94a3b8'">Sort By</div>
                                            <div class="custom-option" data-value="titleAsc" style="padding: 10px 15px; cursor: pointer; border-radius: 8px; font-size: 0.9rem; color: #94a3b8; transition: all 0.2s; margin-bottom: 2px;" onmouseover="this.style.background='rgba(255, 255, 255, 0.05)'; this.style.color='#ffffff'" onmouseout="this.style.background='transparent'; this.style.color='#94a3b8'">Title (A-Z)</div>
                                            <div class="custom-option" data-value="titleDesc" style="padding: 10px 15px; cursor: pointer; border-radius: 8px; font-size: 0.9rem; color: #94a3b8; transition: all 0.2s; margin-bottom: 2px;" onmouseover="this.style.background='rgba(255, 255, 255, 0.05)'; this.style.color='#ffffff'" onmouseout="this.style.background='transparent'; this.style.color='#94a3b8'">Title (Z-A)</div>
                                            <div class="custom-option" data-value="dateAsc" style="padding: 10px 15px; cursor: pointer; border-radius: 8px; font-size: 0.9rem; color: #94a3b8; transition: all 0.2s; margin-bottom: 2px;" onmouseover="this.style.background='rgba(255, 255, 255, 0.05)'; this.style.color='#ffffff'" onmouseout="this.style.background='transparent'; this.style.color='#94a3b8'">Date (Oldest)</div>
                                            <div class="custom-option" data-value="dateDesc" style="padding: 10px 15px; cursor: pointer; border-radius: 8px; font-size: 0.9rem; color: #94a3b8; transition: all 0.2s;" onmouseover="this.style.background='rgba(255, 255, 255, 0.05)'; this.style.color='#ffffff'" onmouseout="this.style.background='transparent'; this.style.color='#94a3b8'">Date (Newest)</div>
                                        </div>
                                    </div>
                                        ...
                                        document.addEventListener('DOMContentLoaded', function() {
                                            ...
                                            trigger.addEventListener('click', function(e) {
                                                ...
                                                if (isOpen) {
                                                    ...
                                                    trigger.style.borderColor = '#E19864';
                                                    trigger.style.boxShadow = '0 0 0 3px rgba(225, 152, 100, 0.1)';
                                                }
                                            });
                                    ...
                                    <div style="position: relative;">
                                        <input type="text" id="adminEventSearch" placeholder="Search event by title..." style="padding: 10px 15px 10px 35px; border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.1); background: rgba(30, 41, 59, 0.5); color: #ffffff; width: 250px; outline: none; transition: border-color 0.2s; font-family: inherit;" onfocus="this.style.borderColor='#E19864'" onblur="this.style.borderColor='rgba(255, 255, 255, 0.1)'">
                                    ...
                                    <span style="background: rgba(225, 152, 100, 0.15); color: #E19864; padding: 8px 16px; border-radius: 50px; font-size: 0.9rem; font-weight: 700; white-space: nowrap;">
                                        <?= count($evenements ?? []) ?> Total Events
                                    </span>
                                </div>
                            </div>

                            <div class="table-responsive" style="overflow-x: auto; border-radius: 14px; border: 1px solid rgba(255, 255, 255, 0.05); box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                                <table style="width: 100%; border-collapse: collapse; text-align: left;">
                                    <thead>
                                        <tr style="background: rgba(30, 41, 59, 0.5); border-bottom: 2px solid rgba(255, 255, 255, 0.05);">
                                            <th style="padding: 1rem 0.5rem; color: #94a3b8; font-weight: 600; font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.05em;">ID</th>
                                            <th style="padding: 1rem 0.5rem; color: #94a3b8; font-weight: 600; font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.05em;">Title</th>
                                            <th style="padding: 1rem 0.5rem; color: #94a3b8; font-weight: 600; font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.05em;">Description</th>
                                            <th style="padding: 1rem 0.5rem; color: #94a3b8; font-weight: 600; font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.05em;">Date</th>
                                            <th style="padding: 1rem 0.5rem; color: #94a3b8; font-weight: 600; font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.05em;">Location</th>
                                            <th style="padding: 1rem 0.5rem; color: #94a3b8; font-weight: 600; font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.05em;">Cap.</th>
                                            <th style="padding: 1rem 0.5rem; color: #94a3b8; font-weight: 600; font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.05em;">Type</th>
                                            <th style="padding: 1rem 0.5rem; color: #94a3b8; font-weight: 600; font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.05em;">Status</th>
                                            <th style="padding: 1rem 0.5rem; color: #94a3b8; font-weight: 600; font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.05em;">Resources</th>
                                            <th style="padding: 1rem 0.5rem; color: #94a3b8; font-weight: 600; font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.05em;">Creator</th>
                                            <th style="padding: 1rem 0.5rem; color: #94a3b8; font-weight: 600; font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.05em;">Actions</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php if (!empty($evenements)): ?>
                                            <?php foreach ($evenements as $evenement): ?>
                                                ...
                                                ?>
                                                <tr style="border-bottom: 1px solid rgba(255, 255, 255, 0.05); transition: background 0.2s; cursor: pointer;" onmouseover="this.style.background='rgba(255, 255, 255, 0.02)'" onmouseout="this.style.background='transparent'" onclick="showParticipantsListModal(<?= (int) $evenement['id'] ?>, <?= isset($_SESSION['user_id']) && $evenement['created_by'] == $_SESSION['user_id'] ? 'true' : 'false' ?>)">
                                                    <td style="padding: 1rem 0.5rem; color: #94a3b8; font-size: 0.85rem; font-weight: 500;">#<?= htmlspecialchars((string) $evenement['id']) ?></td>
                                                    <td style="padding: 1rem 0.5rem; color: #ffffff; font-weight: 700; font-size: 0.9rem;"><?= htmlspecialchars($evenement['titre'] ?: $evenement['title']) ?></td>
                                                    <td style="padding: 1rem 0.5rem; color: #94a3b8; font-size: 0.85rem; max-width: 150px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" title="<?= htmlspecialchars($descFull) ?>">
                                                        <?= htmlspecialchars($descFull ?: '—') ?>
                                                    </td>
                                                    <td style="padding: 1rem 0.5rem; color: #cbd5e1; font-size: 0.85rem;">
                                                        <div style="font-weight: 600; color: #E19864;"><?= htmlspecialchars((string) (($evenement['date_debut'] ?? '') ?: (!empty($evenement['event_date']) ? date('M d, Y', strtotime((string) $evenement['event_date'])) : 'N/A'))) ?></div>
                                                    ...
                                                    <td style="padding: 1rem 0.5rem; color: #cbd5e1; font-size: 0.85rem; font-weight: 500;">
                                                    ...
                                                    <td style="padding: 1rem 0.5rem; color: #cbd5e1; font-size: 0.85rem; font-weight: 500;"><?= htmlspecialchars((string) (($evenement['capacite_max'] ?? '') ?: 'N/A')) ?></td>
                                                    <td style="padding: 1rem 0.5rem; color: #cbd5e1; font-size: 0.85rem; font-weight: 500;">
                                                        <span style="background: rgba(255, 255, 255, 0.05); color: #94a3b8; padding: 4px 8px; border-radius: 6px; font-size: 0.75rem; border: 1px solid rgba(255, 255, 255, 0.1);">
                                                            <?= htmlspecialchars((string) (($evenement['type'] ?? '') ?: 'N/A')) ?>
                                                        </span>
                                                    </td>
                                                    <td style="padding: 1rem 0.5rem;">
                                                        <span style="background: <?= $statutBg ?>; color: <?= $statutColor ?>; padding: 4px 10px; border-radius: 50px; font-size: 0.75rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; display: inline-block;">
                                                            <?= htmlspecialchars((string) (($evenement['statut'] ?? '') ?: 'planifie')) ?>
                                                        </span>
                                                    </td>
                                                    <td style="padding: 1rem 0.5rem;">
                                                        <a href="<?= APP_ENTRY ?>?url=ressource/evenement-ressources&evenement_id=<?= (int) $evenement['id'] ?>" onclick="event.stopPropagation();" style="background: rgba(225, 152, 100, 0.15); color: #E19864; text-decoration: none; padding: 4px 10px; border-radius: 50px; font-size: 0.8rem; font-weight: 700; display: inline-flex; align-items: center; gap: 4px; transition: background 0.2s;" onmouseover="this.style.background='rgba(225, 152, 100, 0.25)'" onmouseout="this.style.background='rgba(225, 152, 100, 0.15)'">
                                                            ...
                                                            <?= (int) ($evenement['resource_count'] ?? 0) ?>
                                                        </a>
                                                    </td>
                                                    <td style="padding: 1rem 0.5rem;">
                                                        <?php
                                                        ...
                                                        <div style="display: flex; align-items: center; gap: 8px;">
                                                            <div style="width: 28px; height: 28px; background: linear-gradient(135deg, #E19864 0%, #d9804b 100%); color: #fff; border-radius: 6px; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 0.85rem;">
                                                                <?= strtoupper(substr($evenement['creator_name'] ?? 'A', 0, 1)) ?>
                                                            </div>
                                                            <div style="display: flex; flex-direction: column;">
                                                                <span style="color: #ffffff; font-weight: 700; font-size: 0.85rem; white-space: nowrap;"><?= htmlspecialchars((string) ($evenement['creator_name'] ?? 'Admin')) ?></span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td style="padding: 1rem 0.5rem;">
                                                        <div style="display: flex; gap: 8px;">
                                                            <a href="<?= APP_ENTRY ?>?url=event/edit-evenement/<?= (int) $evenement['id'] ?>" onclick="event.stopPropagation();" style="background: rgba(255, 255, 255, 0.05); border: 1.5px solid rgba(255, 255, 255, 0.1); color: #94a3b8; text-decoration: none; width: 36px; height: 36px; display: flex; align-items: center; justify-content: center; border-radius: 8px; transition: all 0.2s;" onmouseover="this.style.borderColor='#E19864'; this.style.color='#E19864'" onmouseout="this.style.borderColor='rgba(255, 255, 255, 0.1)'; this.style.color='#94a3b8'" title="Edit">
                                                            ...
                                                            <?php else: ?>
                                                            <div onclick="event.stopPropagation();" style="width: 36px; height: 36px; display: flex; align-items: center; justify-content: center; border-radius: 8px; background: rgba(255, 255, 255, 0.05); color: rgba(255, 255, 255, 0.1); border: 1.5px solid rgba(255, 255, 255, 0.05); cursor: not-allowed;" title="Only the creator can delete this event">
                                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg>
                                                            </div>
                                                            <?php endif; ?>
                                                        </div>
...
function aiPredictEvents(role) {
    ...
    fetch('<?= APP_ENTRY ?>?url=event/predict-top-events&role=' + role)
        ...
        .catch(err => {
            loader.style.display = 'none';
            resultsContainer.style.display = 'flex';
            resultsContainer.innerHTML = '<div style="text-align:center; padding: 2rem; color: #dc2626; background: #fef2f2; border-radius: 12px;">An error occurred while fetching predictions.</div>';
        });
}
