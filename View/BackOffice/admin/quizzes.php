<?php
$adminSidebarActive = 'quizzes'; // Update to match the active state in admin_header.php
$top = isset($quizTopStats) && is_array($quizTopStats) ? $quizTopStats : [];
?>
<div class="pro-table-page" style="padding: 0;">
    <div class="pro-table-head">
        <div>
                    ...
                    <div class="pro-table-actions">
                        ...
                        <a href="<?= APP_ENTRY ?>?url=admin-quiz/add-quiz" class="btn btn-primary">
                            <i class="bi bi-plus-lg" aria-hidden="true"></i> Nouveau quiz
                        </a>
                    </div>
                </div>
                <?php if (!empty($flash)): ?>
