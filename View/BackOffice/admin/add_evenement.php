                        ...
                        <div style="padding: 3rem; background: transparent;">
                            <form action="<?= APP_ENTRY ?>?url=event/store-evenement" method="POST" class="neo-form-grid" novalidate>
                                ...
                                <div class="col-span-2" style="margin-top: 1.5rem; display: flex; gap: 1rem; justify-content: flex-end;">
                                    <button type="submit" name="action" value="save" class="neo-submit-btn" style="width: auto; padding: 14px 28px; background: rgba(255, 255, 255, 0.05); color: #cbd5e1; border: 1.5px solid rgba(255, 255, 255, 0.1); box-shadow: none; font-size: 1rem;">Create Only</button>
...
<style>
    .neo-form-grid {
        ...
        gap: 2.5rem 1.5rem; /* Increased vertical gap to 2.5rem */
    }
    .col-span-2 {
        grid-column: span 2;
    }
