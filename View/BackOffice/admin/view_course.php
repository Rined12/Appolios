...
<div class="dashboard">
    <div class="admin-page-container">
            ...
            <div class="admin-page-content">
                ...
                <div style="background: white; border-radius: 20px; padding: 2rem; margin-bottom: 2rem; box-shadow: 0 5px 20px rgba(0,0,0,0.03); border: 1px solid #eef2f6;">
                    <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem;">
                        <div>
                            ...
                            <p style="margin: 0; color: #64748b;">By <?= htmlspecialchars($creator['name'] ?? 'Unknown') ?></p>
                        </div>
                ...
                <div style="background: white; border-radius: 20px; padding: 2rem; margin-bottom: 2rem; box-shadow: 0 5px 20px rgba(0,0,0,0.03); border: 1px solid #eef2f6;">
                    <h2 style="margin: 0 0 1rem; font-size: 1.25rem; color: #1e293b;">Enrollments</h2>
                    <p style="color: #64748b; margin: 0;">Total Students: <strong style="color: #3b82f6;"><?= count($enrollments) ?></strong></p>
                </div>
                <?php endif; ?>
