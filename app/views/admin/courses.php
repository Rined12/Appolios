            ...
            <div class="table-responsive">
                <table>
                    ...
                    <tbody>
                        <?php if (!empty($courses)): ?>
                            <?php foreach ($courses as $course): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= APP_URL ?>/index.php?url=admin/course/<?= (int) $course['id'] ?>/chapitres" class="btn btn-yellow action-btn" style="padding: 5px 10px; font-size: 0.8rem;">Chapitres</a>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="6" style="text-align: center; padding: 30px;">No courses found. <a href="<?= APP_URL ?>/index.php?url=admin/add-course">Add your first course</a></td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
