...
$action = $isEdit
    ? APP_URL . '/index.php?url=admin/questions/update/' . (int) $question['id']
    : APP_URL . '/index.php?url=admin/questions/store';
    ...
    <div class="container admin-dashboard-container">
        <div class="admin-layout">
            ...
            <div class="admin-main">
                ...
                <p><a href="<?= APP_URL ?>/index.php?url=admin/questions">← Banque</a></p>
                <?php if (!empty($flash)): ?>
                ...
                <form method="post" action="<?= $action ?>" class="table-container" style="padding:24px;max-width:640px;">
                    <label>Titre (optionnel)<br><input type="text" name="title" class="form-control" style="width:100%;" value="<?= htmlspecialchars($question['title'] ?? '') ?>"></label>
                    <br><br>
