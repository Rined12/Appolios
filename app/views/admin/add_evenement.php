...
<div class="dashboard">
    <div class="container">
        <div class="dashboard-header" style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 15px;">
            <div>
                <h1>Add New Evenement</h1>
                <p>Create a new event for your platform</p>
            </div>
        ...
        <div class="form-container" style="max-width: 760px;">
            <form action="<?= APP_URL ?>/index.php?url=admin/store-evenement" method="POST">
                ...
                <button type="submit" class="btn btn-yellow btn-block" style="margin-top: 20px;">Create Evenement</button>
            </form>
        </div>
    </div>
</div>
