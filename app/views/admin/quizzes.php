        ...
        <div class="admin-layout">
            ...
            <div class="admin-main">
                <div class="dashboard-header" style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:12px;">
                    <h1>Quiz (admin)</h1>
                    <a href="<?= APP_URL ?>/index.php?url=admin/quiz/add" class="btn btn-yellow">Nouveau quiz</a>
                </div>
                <?php if (!empty($flash)): ?>
                        ...
                        <table class="data-table" style="width:100%;">
                            ...
                            <?php if (!empty($quizzes)): foreach ($quizzes as $q): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= APP_URL ?>/index.php?url=admin/quiz/edit/<?= (int) $q['id'] ?>" class="btn btn-secondary" style="padding:6px 12px;">Modifier</a>
                                        <a href="<?= APP_URL ?>/index.php?url=admin/quiz/delete/<?= (int) $q['id'] ?>" class="btn action-btn danger" style="padding:6px 12px;" data-confirm="Supprimer ?">Supprimer</a>
                                    </td>
                                </tr>
                            <?php endforeach; else: ?>
