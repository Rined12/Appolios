        ...
        <div class="admin-layout">
            ...
            <div class="admin-main">
                <div class="dashboard-header" style="display:flex;align-items:center;gap:12px;margin-bottom:30px;">
                    <a href="<?= $slBase ?>groupe" class="btn btn-outline" style="padding:8px 14px;">
                ...
                <div class="flash-message info" style="margin-bottom:20px;">
                    Votre groupe sera enregistré comme <strong>demande</strong> : un administrateur devra l’accepter avant publication dans le catalogue.
                </div>
                ...
                <div class="table-container" style="max-width:700px;">
                    ...
                    <div style="padding:32px;">
                        ...
                        <?php if (!empty($errors)): ?>
                        <div class="sl-errors" id="server-errors" style="margin-bottom:20px;">
                        ...
                        <form method="POST" action="<?= $slBase ?>groupe/store" id="form-create-groupe" novalidate>
                            ...
                            <div class="sl-form-group" id="fg-desc" style="margin-top:20px;">
                                ...
                                <textarea id="description" name="description" rows="5"
                                          class="sl-input sl-textarea" maxlength="8000"
                            ...
                            <div style="display:flex;gap:12px;margin-top:28px;flex-wrap:wrap;">
                                ...
                                <a href="<?= $slBase ?>groupe" class="btn btn-outline" style="padding:12px 24px;">Annuler</a>
                            </div>
                        </form>
                    </div>
                </div>
