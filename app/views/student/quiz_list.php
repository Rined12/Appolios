            ...
            <div class="admin-main">
                <div class="dashboard-header" style="display:flex;justify-content:space-between;align-items:flex-start;flex-wrap:wrap;gap:12px;">
                    ...
                    <div style="display:flex;flex-wrap:wrap;gap:8px;">
                        ...
                        <a href="<?= APP_URL ?>/index.php?url=student/chapitres" class="btn btn-outline">Chapitres</a>
                    </div>
                </div>
                                    ...
                                    <tbody>
                                        <?php foreach ($block['rows'] as $q): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary" style="padding:6px 14px;white-space:nowrap;" href="<?= APP_URL ?>/index.php?url=student/quiz/<?= (int) $q['id'] ?>">Commencer</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
