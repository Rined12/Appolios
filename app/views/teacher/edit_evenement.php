<?php
/**
 * APPOLIOS - Teacher Edit Evenement
 */
    ...
    <div class="container admin-dashboard-container">
        ...
        <div class="dashboard-header" style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 15px;">
            <div>
                ...
                <p>Any update on approved evenement sends it back to pending admin review</p>
                <p style="margin-bottom: 0;"><strong>Current approval:</strong> <?= htmlspecialchars($approval) ?></p>
            </div>
        ...
        <div class="form-container" style="max-width: 760px;">
            <form action="<?= APP_URL ?>/index.php?url=teacher/update-evenement/<?= (int) ($evenement['id'] ?? 0) ?>" method="POST">
                ...
                <button type="submit" class="btn btn-yellow btn-block" style="margin-top: 20px;">Save Changes</button>
            </form>
        </div>
            </div>
        </div>
