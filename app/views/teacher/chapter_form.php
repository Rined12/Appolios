...
if ($formGlobal) {
    $action = APP_URL . '/index.php?url=teacher/chapitres/store-global';
} elseif ($isEdit) {
    $action = APP_URL . '/index.php?url=teacher/chapitre/' . (int) $chapter['id'] . '/update';
} else {
    $action = APP_URL . '/index.php?url=teacher/course/' . (int) $course['id'] . '/chapitres/store';
}
$backHref = $formGlobal || $isEdit
    ? APP_URL . '/index.php?url=teacher/chapitres'
    : APP_URL . '/index.php?url=teacher/course/' . (int) $course['id'] . '/chapitres';
?>
<div class="dashboard">
