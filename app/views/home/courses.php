                    ...
                    <div class="course-card">
                        ...
                        <div class="course-content">
                            ...
                            <?php if (isset($_SESSION['logged_in']) && $_SESSION['logged_in']): ?>
                                <a href="<?= APP_URL ?>/student/course/<?= $course['id'] ?>" class="btn btn-primary btn-block" style="margin-top: 15px;">View Course</a>
                            <?php else: ?>
                                <a href="<?= APP_URL ?>/login" class="btn btn-secondary btn-block" style="margin-top: 15px;">Login to Enroll</a>
                            <?php endif; ?>
                        </div>
                    </div>
                <?php endforeach; ?>
