                ...
                <div class="pro-dashboard-grid">
                    ...
                    <div class="pro-main-col" style="display: flex; flex-direction: column; gap: 2rem;">
                        ...
                        <div style="background: white; border-radius: 20px; padding: 2rem; box-shadow: 0 5px 20px rgba(0,0,0,0.03); border: 1px solid #eef2f6;">
                            <h3 style="margin: 0 0 1.5rem 0; font-size: 1.3rem; color: #2B4865; font-weight: 800; display: flex; align-items: center; gap: 10px;">
                            ...
                            <div style="display: flex; flex-wrap: wrap; gap: 1rem;">
                                <a href="<?= APP_ENTRY ?>?url=admin/add-evenement" class="pro-action-btn primary">Add Evenement</a>
                                <a href="<?= APP_ENTRY ?>?url=admin/add-course" class="pro-action-btn primary">Add Course</a>
                                <a href="<?= APP_ENTRY ?>?url=admin/courses" class="pro-action-btn outline">Manage Courses</a>
                                <a href="<?= APP_ENTRY ?>?url=admin/users" class="pro-action-btn outline">Manage Users</a>
                                <a href="<?= APP_ENTRY ?>?url=admin/teachers" class="pro-action-btn outline">Manage Teachers</a>
                            </div>
                        </div>
                        ...
                        <div style="background: white; border-radius: 20px; box-shadow: 0 5px 20px rgba(0,0,0,0.03); border: 1px solid #eef2f6; overflow: hidden;">
                            <div style="padding: 1.5rem 2rem; border-bottom: 1px solid #f1f5f9; display: flex; justify-content: space-between; align-items: center;">
                                ...
                                <a href="<?= APP_ENTRY ?>?url=admin/evenements" style="color: #548CA8; text-decoration: none; font-size: 0.9rem; font-weight: 600; padding: 6px 12px; border-radius: 6px; background: #e9f1fa; transition: background 0.2s;" onmouseover="this.style.background='#d0e3f5'" onmouseout="this.style.background='#e9f1fa'">View All</a>
                            </div>
                            <div style="overflow-x: auto;">
                                <table style="width: 100%; border-collapse: collapse; text-align: left;">
                                    ...
                                    <tbody>
                                        ...
                                        <?php else: ?>
                                            <tr>
                                                <td colspan="3" style="text-align: center; padding: 2.5rem; color: #94a3b8;">No events yet. <a href="<?= APP_ENTRY ?>?url=admin/add-evenement" style="color: #548CA8; text-decoration: underline;">Create your first evenement</a></td>
                                            </tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
