...
<aside class="admin-sidebar dark-theme">
    <nav class="admin-sidebar-nav" aria-label="Admin Navigation">
        ...
        <a href="<?= APP_ENTRY ?>?url=admin/student-progress" class="admin-side-link <?= $adminSidebarActive === 'student-progress' ? 'active' : '' ?>">
            <span class="admin-side-icon" aria-hidden="true">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <a href="<?= APP_ENTRY ?>?url=admin/categories" class="admin-side-link <?= $adminSidebarActive === 'categories' ? 'active' : '' ?>">
            <span class="admin-side-icon" aria-hidden="true">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <a href="<?= APP_ENTRY ?>?url=admin/contact-messages" class="admin-side-link <?= $adminSidebarActive === 'contact-messages' ? 'active' : '' ?>">
            ...
            require_once 'C:/xampp/htdocs/Appolios-feature-user/Appolios-feature-user/Model/ContactMessage.php';
